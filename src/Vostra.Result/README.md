...
- Companion packages: **Vostra.Result.AspNetCore** (`Result` → HTTP), **Vostra.Result.Testing**
  (transport-neutral chain & assert over any `Task<Result<T>>`), and **Vostra.Result.AspNetCore.Testing**
