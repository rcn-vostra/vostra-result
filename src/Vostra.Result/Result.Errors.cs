...
{
    /// <summary>
    /// Creates a <see cref="Vostra.Result.ValidationError"/> (input failed validation). Pass
    ...
    /// <summary>Creates a <see cref="Vostra.Result.NotFoundError"/> (a requested resource was not found).</summary>
    ...
    /// <summary>Creates a <see cref="Vostra.Result.ConflictError"/> (the request conflicts with current state).</summary>
    ...
    /// <summary>Creates an <see cref="Vostra.Result.AlreadyExistsError"/> (a resource already exists).</summary>
    ...
    /// <summary>Creates an <see cref="Vostra.Result.UnauthorizedError"/> (authentication is required or failed).</summary>
    ...
    /// <summary>Creates a <see cref="Vostra.Result.ForbiddenError"/> (authenticated but not permitted).</summary>
    ...
    /// <summary>
    /// Creates a failure from a message, backed by the catch-all <see cref="Vostra.Result.Error"/>
